...
class Lambda extends RequestStreamHandler {
  ...
  private def copyFromSourceToDestination(input: Input, destinationBucket: String, asset: DynamoTable, child: DynamoTable, xmlCreator: XMLCreator) = {
    s3Client.copy(
      input.sourceBucket,
  ...
  private def destinationPath(input: Input, asset: DynamoTable, child: DynamoTable, xmlCreator: XMLCreator) =
